    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <form method="post" action="{{ route('almoxarifado.saida.store') }}" autocomplete="off">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Nova saída de produto</h5>
                        </div>
                        <div class="card-body">
                            <select class="form-control" name="produto_id">
                                <option value="" selected>Selecione o Produto</option>
                                @foreach ($produtos as $produto)
                                <option value="{{ $produto->produto_id }}" @if (old('produto_id')==$produto->produto_id) {{ 'selected' }} @endif>
                                    {{ $produto->nome }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="card-body">
                            <select class="form-control" name="tipo_saida_id">
                                ...
                                <option value="{{ $tipo_saida->tipo_saida_id }}" @if (old('tipo_saida_id')==$tipo_saida->tipo_saida_id) {{ 'selected' }} @endif>
                        ...
                        <div class="card-body">
                            <select class="form-control" name="venda_id">
                                ...
                                <option value="{{ $venda->venda_id }}" @if (old('venda_id')==$venda->venda_id) {{ 'selected' }} @endif>
                        ...
                        <div class="card-body">
                            <input type="number" step=".01" name="quantidade" maxlength='255' class="form-control" placeholder="Quantidade">
                        </div>
                        <div class="card-body">
